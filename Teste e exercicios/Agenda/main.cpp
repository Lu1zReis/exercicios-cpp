...
void lista(){
    ...
    //declaramos a condi��o if para ele nao ficar rodando todo o vetor de SIZE que tem 200 de memoria
    //j� o * serve como ponteiro para puxar os dados da var global 'nome'
    ...
    /*o break serve para que se no if por exemplo, tem um valor na linha 0, 1, mas na 2, ja n�o tem nada
    ele vai checar isso e entrar no else e vai sair do la�o de repeticao.
    */
            break;
        }
    }
...
/*aqui nas var 'nome', 'email' e 'telefone', como ja dito antes, o & vai alocar o valor na memoria
 ...
 chamarmos quando precisarmos na fun��o 'pesquisa'.
 */
       scanf("%s", &nome[linha]);
       printf("Digite o E-mail: ");
       scanf("%s", &email[linha]);
